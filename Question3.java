...
////                    score[9] = "fail";
//                    //show qualified page
//                    Intent mv = new Intent(Question3.this, TriviaPassed.class);
...
////                    score[8] = "fail";
////                    score[9] = "fail";
//                    Intent mv = new Intent(Question3.this, TriviaFail.class);
//                    mv.putExtra("counter", counters);
//                    mv.putExtra("category", Text);
//                    mv.putExtra("question", questio);
//                    mv.putExtra("score", score);
...
//                }
        ...
        opt2.setText(optionB_list.get(2));
        opt3.setText(optionC_list.get(2));
        opt4.setText(optionD_list.get(2));

        final String ans = correct_option_list.get(2);
                ...
                if(ans.equals(opt1.getText().toString())){
                    ...
                    new Timer().schedule(new TimerTask() {
                        ...
                        public void run() {
                            ...
                            Intent mv = new Intent(Question3.this, Question4.class);
