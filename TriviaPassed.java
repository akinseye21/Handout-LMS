...
//        }
        ...
        mainMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent j = new Intent(TriviaPassed.this, HandoutCovid19.class);
                startActivity(j);
            }
        });
...
//                mDrawerLayout.openDrawer(Gravity.LEFT);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent move1 = new Intent(TriviaPassed.this, HandoutCovid19.class);
                startActivity(move1);
            }
        });
        ...
        cov19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent move2 = new Intent(TriviaPassed.this, WorldMap.class);
                startActivity(move2);
            }
        });
        ...
        tips.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent move4 = new Intent(TriviaPassed.this, CovidTips.class);
                startActivity(move4);
            }
        });
        ...
        games.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent move3 = new Intent(TriviaPassed.this, HandoutTrivia.class);
                startActivity(move3);
            }
        });
    }
