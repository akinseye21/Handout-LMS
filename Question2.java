...
//
//                    //show qualified page
//                    Intent mv = new Intent(Question2.this, TriviaPassed.class);
...
////                    score[9] = "fail";
//
//                    Intent mv = new Intent(Question2.this, TriviaFail.class);
//                    mv.putExtra("counter", counters);
//                    mv.putExtra("category", Text);
//                    mv.putExtra("question", questio);
//                    mv.putExtra("score", score);
...
//                }
        ...
        final String ans = correct_option_list.get(1);
                ...
                if(ans.equals(opt1.getText().toString())){
                    ...
                    new Timer().schedule(new TimerTask() {
                        ...
                        public void run() {
                            ...
                            Intent mv = new Intent(Question2.this, Question3.class);
