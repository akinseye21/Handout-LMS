...
////                    score[9] = "fail";
//                    //show qualified page
//                    Intent mv = new Intent(Question4.this, TriviaPassed.class);
...
////                    score[9] = "fail";
//
//                    Intent mv = new Intent(Question4.this, TriviaFail.class);
//                    mv.putExtra("counter", counters);
//                    mv.putExtra("category", Text);
//                    mv.putExtra("question", questio);
//                    mv.putExtra("score", score);
                ...
                if(ans.equals(opt1.getText().toString())){
                    ...
                    new Timer().schedule(new TimerTask() {
                        ...
                        public void run() {
                            ...
                            Intent mv = new Intent(Question4.this, Question5.class);
