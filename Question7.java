...
//
//                    //show qualified page
//                    Intent mv = new Intent(Question7.this, TriviaPassed.class);
...
////                    score[9] = "fail";
//
//                    Intent mv = new Intent(Question7.this, TriviaFail.class);
//                    mv.putExtra("counter", counters);
//                    mv.putExtra("category", Text);
//                    mv.putExtra("question", questio);
//                    mv.putExtra("score", score);
...
//                }
        ...
        quest.setText(question_list.get(6));
        opt1.setText(optionA_list.get(6));
        opt2.setText(optionB_list.get(6));
        opt3.setText(optionC_list.get(6));
        opt4.setText(optionD_list.get(6));

        final String ans = correct_option_list.get(6);
                ...
                if(ans.equals(opt1.getText().toString())){
                    ...
                    new Timer().schedule(new TimerTask() {
                        ...
                        public void run() {
                            ...
                            Intent mv = new Intent(Question7.this, Question8.class);
